    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-white border-b border-border sticky top-16 z-30">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 py-3 flex items-center gap-3">
          <Link href="/chat" className="h-9 w-9 rounded-lg flex items-center justify-center hover:bg-muted transition-colors" aria-label="Back to chat list">
      ...
      <div className="bg-white border-t border-border sticky bottom-0">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 py-3">
          ...
          >
            <button type="button" className="h-10 w-10 rounded-lg flex items-center justify-center hover:bg-muted transition-colors text-muted-foreground" aria-label="Attach image">
