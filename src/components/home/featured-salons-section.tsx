...
import { Star, ArrowRight, MapPin, Loader2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { useLocale } from "@/hooks/use-locale";
import { useFeaturedSalons } from "@/hooks/use-salons";
import Link from "next/link";
import Image from "next/image";

export function FeaturedSalonsSection() {
  const { t } = useLocale();
  const { data: featured, isLoading } = useFeaturedSalons();
              ...
              >
                ...
                <div className="relative aspect-[4/3] bg-[#F5EDE6] overflow-hidden">
                  ...
                  {salon.owner.profileImage ? (
                    ...
                    <div className="flex items-center justify-center h-full text-[#C9AA8B] text-2xl font-bold">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-1 mt-1.5 text-muted-foreground">
                    ...
                    <span className="text-sm line-clamp-1">{salon.city || salon.address}</span>
                  </div>
